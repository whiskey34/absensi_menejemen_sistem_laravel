...
Route::group(['middleware' => ['auth', 'Role'], 'roles' => ['admin']], function () {
    ...
    Route::resource('/role_setting', '\App\Http\Controllers\RolesController');
    // Route::post('/role_setting', '\App\Http\Controllers\RolesController@store')->name('role_store');
...
// Route::group(['middleware' => ['auth', 'Role'], 'roles' => ['user', 'admin']], function () {
